...
if(!isset($_REQUEST['id']) || empty($course = getCourseById($_REQUEST['id']))) {
    header("location: course.php");
    exit;
}

$previousValue = array(
    'id' => isset($_POST['id']) ? $_POST['id'] : $course['id'],
    'course_name' => isset($_POST['course_name']) ? $_POST['course_name'] : $course['course_name'],
    'author' => isset($_POST['author']) ? $_POST['author'] : $course['author'],
    'duration' => isset($_POST['duration']) ? $_POST['duration'] : $course['duration'],
    'original_price' => isset($_POST['original_price']) ? $_POST['original_price'] : $course['original_price'],
    'selling_price' => isset($_POST['selling_price']) ? $_POST['selling_price'] : $course['selling_price'],
);
...
<table border="1" width="1000" height="70" align="center" cellpadding="15" cellspaceing="0">
    ...
    <tr>
        ...
        <td valign="top">
            <h1 style="color:orange">Update Course</h1>
            <?php if (!empty($errors)) { ?>
                <ul style="color: red">
            ...
            <form method="post">
                <label>
                    Course ID:<br>
                    <input type="text" name="id" placeholder="Enter Course ID" value="<?php echo $previousValue['id'] ?>" readonly>
                </label><br><br>
                <label>
                    Course Name:<br>
